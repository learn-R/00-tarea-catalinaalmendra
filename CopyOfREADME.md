...
R: Catalina Carmona, aunque me acomoda Catalina Almendra, por eso lo utilizo más

2. ¿Cuál es la diferencia entre R y RStudio?


R: R es un lenguaje que puede ser utilizado para la creación de diversos elementos tales como sitios web o aplicaciones, por lo que, dada su propiedad de lenguaje, funciona de manera común, permitiendo ser empleado en otras herramientas. Por otro lado, en RStudio es posible ejecutar códigos un poco más orientados al análisis estadístico, con la diferencia de que este precisa de R. 

3. ¿Con qué comando puedes **subir** los cambios del repositorio local al remoto?

R: con el comando push agregamos todos los cambios que hayamos realizado al repositorio remoto u origin
